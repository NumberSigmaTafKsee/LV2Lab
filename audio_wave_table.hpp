...
const int numWaveTableSlots = 256;
...
public:
    ...
    int   addWaveTable(int len, const DspFloatType* waveTableIn, double topFreq);
...
inline void WaveTableOsc::updatePhase() {
    phasor = std::fmod(phasor+phaseInc,1.0);    
}
...
//
inline int WaveTableOsc::addWaveTable(int len, const DspFloatType* waveTableIn, double topFreq) {
