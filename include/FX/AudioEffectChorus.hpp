...
namespace FX
{
    ...
    struct Chorus : public StereoFXProcessor
    {
        ...
        Chorus(DspFloatType sr=44100.0,DspFloatType delay=30, DspFloatType sweep=0.02,DspFloatType depth=1.0, DspFloatType freq=0.2f,Waveform waveform=kWaveformSine,
