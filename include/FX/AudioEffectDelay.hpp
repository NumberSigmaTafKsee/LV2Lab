...
namespace FX
{
    ...
    struct DelayEffect : public StereoFXProcessor
    {
        ...
        sample_vector<DspFloatType> delayBuffer[2];
        sample_vector<size_t> tap_reads;
        size_t taps;
        ...
        DelayEffect() : StereoFXProcessor()
        {
            ...
            memset(delayBuffer[0].data(),0,delayBuffer[0].size()*sizeof(DspFloatType));
            memset(delayBuffer[1].data(),0,delayBuffer[0].size()*sizeof(DspFloatType));
        }
