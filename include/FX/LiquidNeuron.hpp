...
namespace Liquid
{
    ...
    struct LiquidPole
    {
        ...
        LiquidPole(DspFloatType h=0.01, DspFloatType sr=44100.0) :
        filter(sr,h) {
    ...
    struct LiquidTwoPole
    {
        ...
        LiquidTwoPole(DspFloatType h=0.01, DspFloatType sampleRate=44100.0) :
    ...
    struct LiquidSampleHoldMS
    {
        ...
        LiquidSampleHoldMS(DspFloatType ms, DspFloatType sampleRate=44100.0) {
    ...
    struct LiquidSampleHoldHZ
    {
        ...
        LiquidSampleHoldHZ(DspFloatType hz, DspFloatType sampleRate=44100.0) {
            rate = hz / sampleRate;
            p = 0;
        }
        DspFloatType Tick(DspFloatType x)
