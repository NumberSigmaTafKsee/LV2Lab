...
namespace Filters::IIR::ChebyshevFilters
{
    ...
    struct ChebyshevILowPassFilter12db
    {
        ...
        ChebyshevILowPassFilter12db(DspFloatType sampleRate=44100.0)
        {            
            Sr = sampleRate;
            Q  = 0.5;
            setCutoff(1000.0f);
        ...
        void setCutoff(float fc)
        {
            ...
            BiquadSection section = Filters::IIR::AnalogBiquadSection(s[0], fc, Sr);
    ...
    struct ChebyshevIILowPassFilter12db
    {
        ...
        ChebyshevIILowPassFilter12db(DspFloatType sampleRate=44100.0)
        {            
            Sr = sampleRate;
            Q  = 0.5;
            setCutoff(1000.0f);
