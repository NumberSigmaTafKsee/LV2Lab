...
namespace Analog::Envelopes
{
    struct F2PAR : public GeneratorProcessor
    {
        ...
        F2PAR(DspFloatType a, DspFloatType r, DspFloatType sr=44100) :
        GeneratorProcessor(),
        filter(1/0.01,sr,0.5)
        {
            sampleRate = sr;
            attack_rate = 1/a;                
            release_rate = 1/r;
    ...
    struct F2PASR : public GeneratorProcessor
    {
        ...
        F2PASR(DspFloatType a, DspFloatType s, DspFloatType r,DspFloatType sampleRate=44100)
        : GeneratorProcessor(),
    ...
    struct F2PADSR : public GeneratorProcessor
    {
        ...
        F2PADSR(DspFloatType a, DspFloatType d, DspFloatType s, DspFloatType r,DspFloatType sampleRate=44100)
        : GeneratorProcessor(),
        filter(1/0.01,sampleRate,0.5)
        {
            this->sampleRate = sampleRate;
