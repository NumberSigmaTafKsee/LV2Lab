...
#define SWIGTYPE_p_FloatBuffer swig_types[0]
...
#define SWIG_name      "floatbuffer"
#define SWIG_init      luaopen_floatbuffer
#define SWIG_init_user luaopen_floatbuffer_user

#define SWIG_LUACODE   luaopen_floatbuffer_luacode
...
static int _wrap_new_FloatBuffer(lua_State* L) {
  ...
  SWIG_check_num_args("FloatBuffer::FloatBuffer",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("FloatBuffer::FloatBuffer",1,"size_t");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FloatBuffer::FloatBuffer",2,"void *");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (size_t)lua_tonumber(L, 1);
  arg2=(void *)SWIG_MustGetPtr(L,2,0,0,2,"new_FloatBuffer");
  result = (FloatBuffer *)new FloatBuffer(arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FloatBuffer,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FloatBuffer___getitem(lua_State* L) {
  int SWIG_arg = 0;
  FloatBuffer *arg1 = (FloatBuffer *) 0 ;
  size_t arg2 ;
  float result;
  
  SWIG_check_num_args("FloatBuffer::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FloatBuffer::__getitem__",1,"FloatBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FloatBuffer::__getitem__",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FloatBuffer,0))){
    SWIG_fail_ptr("FloatBuffer___getitem",1,SWIGTYPE_p_FloatBuffer);
  }
...
static int _wrap_FloatBuffer___setitem(lua_State* L) {
  ...
  SWIG_check_num_args("FloatBuffer::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FloatBuffer::__setitem__",1,"FloatBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FloatBuffer::__setitem__",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FloatBuffer::__setitem__",3,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FloatBuffer,0))){
    SWIG_fail_ptr("FloatBuffer___setitem",1,SWIGTYPE_p_FloatBuffer);
  }
...
FloatBuffer *arg1 = (FloatBuffer *) obj;
delete arg1;
}
...
static swig_lua_class _wrap_class_FloatBuffer = { "FloatBuffer", "FloatBuffer", &SWIGTYPE_p_FloatBuffer,_proxy__wrap_new_FloatBuffer, swig_delete_FloatBuffer, swig_FloatBuffer_methods, swig_FloatBuffer_attributes, &swig_FloatBuffer_Sf_SwigStatic, swig_FloatBuffer_meta, swig_FloatBuffer_bases, swig_FloatBuffer_base_names };
...
static swig_type_info _swigt__p_FloatBuffer = {"_p_FloatBuffer", "FloatBuffer *", 0, 0, (void*)&_wrap_class_FloatBuffer, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FloatBuffer,
};

static swig_cast_info _swigc__p_FloatBuffer[] = {  {&_swigt__p_FloatBuffer, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FloatBuffer,
};
