...
#define SWIGTYPE_p_std__numeric_limitsT_float_t swig_types[31]
#define SWIGTYPE_p_std__numeric_limitsT_int_t swig_types[32]
#define SWIGTYPE_p_std__numeric_limitsT_long_long_t swig_types[33]
#define SWIGTYPE_p_std__numeric_limitsT_long_t swig_types[34]
#define SWIGTYPE_p_std__numeric_limitsT_short_t swig_types[35]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_int_t swig_types[36]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_long_t swig_types[37]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_t swig_types[38]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_short_t swig_types[39]
...
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_std__allocatorT_std__complexT_float_t_t_t swig_types[43]
#define SWIGTYPE_p_std__vector_iteratorT_double_std__allocatorT_double_t_t swig_types[44]
#define SWIGTYPE_p_std__vector_iteratorT_float_std__allocatorT_float_t_t swig_types[45]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_double_t_std__allocatorT_std__complexT_double_t_t_t swig_types[46]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_float_t_std__allocatorT_std__complexT_float_t_t_t swig_types[47]
...
static int _wrap_ModulatedDelay_processMono(lua_State* L) {
  int SWIG_arg = 0;
  ModulatedDelay *arg1 = (ModulatedDelay *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("ModulatedDelay::processMono",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ModulatedDelay::processMono",1,"ModulatedDelay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("ModulatedDelay::processMono",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("ModulatedDelay::processMono",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("ModulatedDelay::processMono",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ModulatedDelay,0))){
    SWIG_fail_ptr("ModulatedDelay_processMono",1,SWIGTYPE_p_ModulatedDelay);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ModulatedDelay_processMono",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ModulatedDelay_processMono",4,SWIGTYPE_p_float);
  }
...
static int _wrap_ModulatedDelay_processStereo(lua_State* L) {
  int SWIG_arg = 0;
  ModulatedDelay *arg1 = (ModulatedDelay *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("ModulatedDelay::processStereo",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ModulatedDelay::processStereo",1,"ModulatedDelay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("ModulatedDelay::processStereo",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("ModulatedDelay::processStereo",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("ModulatedDelay::processStereo",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ModulatedDelay,0))){
    SWIG_fail_ptr("ModulatedDelay_processStereo",1,SWIGTYPE_p_ModulatedDelay);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ModulatedDelay_processStereo",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ModulatedDelay_processStereo",4,SWIGTYPE_p_float);
  }
...
static swig_lua_method swig_ModulatedDelay_methods[]= {
    ...
    { "processMono", _wrap_ModulatedDelay_processMono},
    { "processStereo", _wrap_ModulatedDelay_processStereo},
