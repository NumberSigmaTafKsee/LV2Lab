...
lfo1 = functions.SineGenerator(0.01)
lfo2 = functions.SineGenerator(0.1)
lfo3 = functions.SineGenerator(1.0)
lfo1:setRange(0.5,1.0)
lfo2:setRange(0.4,0.6)
...
function noise(input,output,frames)        
    ...
    for i=1,tmpbuf:size() do tmpbuf[i] = distortionfunctions.clipper(tmpbuf[i],3.5) end
