...
namespace Octopus
{
    struct Function
    {
        ...
        ValueList operator()(const ValueList & input, int num_outputs=1)
        {
            return eval(input,num_outputs);
        }

        
        ValueList eval(const ValueList &input, int numOutputs=1)
        {
            return octave::feval(name.c_str(),input,numOutputs);
        }
